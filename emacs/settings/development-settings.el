...
(elpaca smartparens (use-package smartparens
  ;; :ensure t
  :init
...
(elpaca yasnippet (use-package yasnippet
  ;; :ensure t
  :config
  (yas-reload-all)
...
(elpaca toml-mode (use-package toml-mode))
...
;; ;; Nicer blame mode
;; (elpaca mo-git-blame (use-package mo-git-blame
;;   ;; :ensure t
;;   ))

;; (elpaca restclient (use-package restclient
;;   ;; :ensure t
;;   ))

;; ;; rg is enabled in early-misc
;; ;; (use-package rg)
;; (elpaca wgrep (use-package wgrep))

;; ;; Helpfully convert strings between different programming cases
;; https://github.com/akicho8/string-inflection
(elpaca string-inflection (use-package string-inflection
  :general
...
(elpaca json-mode (use-package json-mode)) ;; Without this, js-json mode is used, and tree-sitter doesn't know what to infer from that
